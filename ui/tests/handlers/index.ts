...
import projectMetaEmptyFixture from '../fixtures/projects/meta-empty.json'
...
import urlListProject2Fixture from '../fixtures/url_findings/project-2.json'
import urlListEmptyFixture from '../fixtures/url_findings/empty.json'
import urlListFilterOptionsPopulatedFixture from '../fixtures/url_findings/filter-options-populated.json'
import urlListFilterOptionsEmptyFixture from '../fixtures/url_findings/filter-options-empty.json'
import scanConfigProject1Fixture from '../fixtures/scans/config-project-1.json'
import scanConfigProject2Fixture from '../fixtures/scans/config-project-2.json'
import scanConfigEmptyFixture from '../fixtures/scans/config-empty.json'
import scanHistoryProject1Fixture from '../fixtures/scans/history-project-1.json'
import scanHistoryProject2Fixture from '../fixtures/scans/history-project-2.json'
import scanHistoryEmptyFixture from '../fixtures/scans/history-empty.json'
...
import reportDraftsProject1Fixture from '../fixtures/reports/drafts-project-1.json'
import reportDraftsProject2Fixture from '../fixtures/reports/drafts-project-2.json'
import reportDraftsEmptyFixture from '../fixtures/reports/drafts-empty.json'
import reportHistoryProject1Fixture from '../fixtures/reports/history-project-1.json'
import reportHistoryEmptyFixture from '../fixtures/reports/history-empty.json'
import reportLatestProject1Fixture from '../fixtures/reports/latest-project-1.json'
import reportGenerate202Fixture from '../fixtures/reports/generate-202.json'
import reportDraftStart202Fixture from '../fixtures/reports/draft-start-202.json'
import reportCancel202Fixture from '../fixtures/reports/cancel-202.json'
import reportDraftUpload200Fixture from '../fixtures/reports/draft-upload-200.json'

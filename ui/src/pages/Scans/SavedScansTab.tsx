        ...
        {!isEditing ? (
          ...
          <div className="flex-1 overflow-auto p-4 space-y-4">
            ...
            <div>
              ...
              <div className="text-[10px] text-dim mt-1">Leave empty to scan all repositories</div>
            </div>
            ...
            <div>
              ...
              <div className="text-[10px] text-dim mt-1">
                Leave empty to run all tools. Templates from Config &gt; Tool Overrides appear here.
              </div>
            </div>
              ...
              <div className="flex items-center gap-2">
                {!isCreatingNew && selectedScanId && (
                  <>
                    ...
                    <button
                      onClick={() => onSelect(selectedScanId)}
                      className="flex items-center gap-1 px-3 h-8 text-[10px] uppercase tracking-wider border border-accent text-accent hover:bg-accent/10 transition-colors"
                    >

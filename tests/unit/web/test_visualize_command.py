...
def _make_cmds(active_project: str | None = "testproject") -> FindingsCommands:
    return FindingsCommands(_make_repl_mock(active_project), server_factory=MagicMock())
...
class TestVisualizeCommand:
    ...
    def test_visualize_returns_promptly_when_server_starts(
        ...
        cmds = FindingsCommands(_make_repl_mock(), server_factory=factory)
        cmds.cmd_visualize([])

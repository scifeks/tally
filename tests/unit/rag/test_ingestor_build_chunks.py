"""Unit tests for _normalize_file_path path normalization."""

from __future__ import annotations

from application.rag.ingestor import _normalize_file_path
...
class TestNormalizeFilePath:
    def test_strips_repo_prefix_from_absolute_path(self) -> None:
        ...
        result = _normalize_file_path("/repos/app/src/main.py", repos)
    ...
    def test_with_repo_name_strips_prefix_for_absolute_path(self) -> None:
        ...
        result = _normalize_file_path(
            "/repos/app/src/main.py", repos, repo_name="myapp"
        )
        assert result == ("/src/main.py", "myapp")

    def test_with_repo_name_returns_path_unchanged_when_no_prefix_match(
        self,
    ) -> None:
        repos = [_repo("myapp", "/repos/app")]
        result = _normalize_file_path("config/aws.js", repos, repo_name="myapp")
        assert result == ("config/aws.js", "myapp")

...
class TestBaseProperties:
    def test_name(self) -> None:
        assert KatanaLocalTool().name == "katana"

    def test_scan_segment(self) -> None:
        assert KatanaLocalTool().scan_segment == "web"

    def test_requires_base_urls(self) -> None:
        assert KatanaLocalTool().requires_base_urls is True

    def test_is_discovery_tool(self) -> None:
        assert KatanaLocalTool().is_discovery_tool is True

    def test_findings_exit_ok(self) -> None:
        assert KatanaLocalTool().findings_exit_ok is False
    ...
    def test_should_visualize_is_false(self) -> None:
        assert KatanaLocalTool().should_visualize is False
